...
import cinema.dao.com.AddFilmDAO;
...
public class AddFilmServlet extends HttpServlet {
    ...
    AddFilmDAO dao= new AddFilmDAO();
    boolean success=dao.addFilm(film);

    if (success) {
        request.setAttribute("message","Film added successfully!");} else {
        request.setAttribute("message","Failed to add film. Please try again.");
    }

    request.getRequestDispatcher("addFilmResult.jsp").forward(request, response);
}
    /**
